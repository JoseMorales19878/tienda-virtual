...
//2. referencia a la bd
  const  clientesCollection=collection(db,"servicio")
...
//4 - Funcion para eliminar un doc
  ...
  const clientesDoc = doc(db, "servicio", id)
  ...
  
  {
 ...
 
   {
	  name:"Ver Imagenes",
	cell:(row)=><Link 
	                to={`/Moduloadministrador/PerfilEmpresa/VerImagenesServicios/${row.id}`} 
 ...
 
  {
	  name:"Registrar",
	cell:(row)=><Link 
	                to={`/Moduloadministrador/PerfilEmpresa/RegistrarServiciosImagenes/${row.id}`} 
				    className="btn btn-light">
				    Registrar
			    </Link>
  },
		  ...
		  <div className="container-fluid">
			<div className="row mb-2">
			  <div className="col-sm-6">
				<h1>Modulo Imagenes de Servicios</h1>
			  </div>
			  <div className="col-sm-6">
				<ol className="breadcrumb float-sm-right">
				 ...
				 <Link to="/Moduloadministrador">Inicio</Link>
				  ...
				  <li className="breadcrumb-item active"> Listado Imagenes de Servicios</li>
				</ol>
			  </div>
			</div>
		  </div>
