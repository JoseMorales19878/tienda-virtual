...
const RegistroVehiculoRepartidor = () => {
 ...
 const {id} = useParams()
    ...
    navigate("/Modulo_administrador/PerfilEmpresa/vehiculo_repartidor/vehiculo_repartidor/VehiculoRepartidores/"); 
    }
			...
			<div className="row mb-2">
			  ...
			  <div className="col-sm-6">
				<ol className="breadcrumb float-sm-right">
				  ...
				  <li className="breadcrumb-item active">Registro Vehículo Repartidor</li>
				</ol>
			  </div>
			</div>
		  </div>
			  ...
			  <div className="col-md-12">
				...
				<div className="card card-primary">
				  <div className="card-header">
					<h3 classNames="card-title">Registro Repartidor Vehículo{nombre}</h3>
				  </div>
				 ...
				 <div className="form-group">
				    ...
				    <div className="form-group">
					   ...
					   <img src={foto} className='form-contro' with="100" height="100"/>    
					</div>
...
export default RegistroVehiculoRepartidor
