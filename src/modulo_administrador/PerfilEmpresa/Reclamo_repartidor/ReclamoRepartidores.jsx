...
//4 - Funcion para eliminar un doc
  const deletecategoria = async (id) => {
   const categoriaDoc = doc(db, "reclamo_repartidor", id)
  ...
  
  {
	...
	selector:(row)=><img src={row.imagen_repartidor} width="100" height="100"/>
  },
 ...
 
  {
	...
	cell:(row)=><Link to={`/Moduloadministrador/PerfilEmpresa/Reclamo_repartidor/ResponderReclamoRepartidor/${row.id}`} className="btn btn-light">Responder</Link>
  },
   {
	name:"Eliminar",
		  ...
		  <div className="container-fluid">
			<div className="row mb-2">
			  <div className="col-sm-6">
				<h1>Modulo Reclamo Repartidores</h1>
			  </div>
			  <div className="col-sm-6">
				<ol className="breadcrumb float-sm-right">
				  ...
				  <li className="breadcrumb-item active"> Listado Reclamo Repartidores</li>
				</ol>
			  </div>
			</div>
		  </div>
						   ...
						   <DataTable 
							...
							subHeaderComponent={<input 
												type="text" 
												placeholder="Buscar Reclamo Repartidor ..." 
...
export default ReclamoRepartidores
