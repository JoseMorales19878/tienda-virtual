	  ...
	  async function subirArchivo(e)
   {
    ...
    const getEmpresaById = async (id) => {
        ...
        if(empresa.exists()) {
            ...
            setDnirepartidor(empresa.data().dni_repartido)    
            setNombrerepartidor(empresa.data().nombre_repartidor)
			setApelldiorepartidor(empresa.data().apelldio_repartidor)    
            setDireccionrepartidor(empresa.data().direccion_repartidor)
			setFecha(empresa.data().fecha)    
            setCorreorepartidor(empresa.data().correo_repartidor)
			setSexo(empresa.data().sexo) 
            setTelefonorepartidor(empresa.data().telefono_repartidor) 			
        }else{
